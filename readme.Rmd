...
We can use the properties of a complete graph to check that our.
This Major-Major scale network has 12 nodes, and we have 66 edges, which is what we'd expect from the complete graph formula E = n*(n-1)/2 =  12*11/2 = 66.   Here's a first shot at visualizing:
